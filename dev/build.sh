...
export ASSETS_REPOSITORY="VSSharp/vssharp"
export BINARY_NAME="vssharp"
export CI_BUILD="no"
export GH_REPO_PATH="VSSharp/vssharp"
...
while getopts ":ilops" opt; do
  case "$opt" in
    i)
      export ASSETS_REPOSITORY="VSSharp/vssharp-insiders"
      export BINARY_NAME="vssharp-insiders"
